...
const INITIAL_MENU: MenuItem[] = [
  {
    ...
    desc: { en: "Rich and moist chocolate cake layered with intense chocolate flavor, freshly served for true chocolate lovers.", ar: "كيكة شوكليت غنية وناعمة بطبقات لذيذة من الشوكليت المكثفة، تقدم طازجة لعشاق الطعم الفاخر." },
  ...
  },
  {
    ...
    desc: { en: "Dense chocolate brownie with a soft fudgy center and a lightly crisp outer layer.", ar: "براوني شوكليت كثيف بقوام طري من الداخل ولمسة مقرمشة خفيفة من الخارج." },
  ...
  },
  {
    ...
    desc: { en: "Creamy matcha blended with sweet milk in a rich Spanish latte style.", ar: "ماتشا كريمية ممزوجة بالحليب المحلى بأسلوب سبانش فاخر ومتوازن." },
...
const ISLAMIC_EVENTS: IslamicEvent[] = [
  {
    id: "ramadan",
    name: { en: "Ramadan Kareem", ar: "رمضان الكريم" },
    date: "05-09",
    sticker: "🌙",
    desc: { en: "The Holy Month of Fasting, Prayer & Reflection", ar: "شهر الخير والبركات والعبادة والتقوى" },
    color: "from-[#110022] via-[#030008] to-[#000511]"
  },
  {
    id: "eid_fitr",
    name: { en: "Eid Al-Fitr", ar: "عيد الفطر المبارك" },
    date: "10-01",
    sticker: "🎊",
    desc: { en: "Celebration of Breaking the Fast — Eid Mubarak!", ar: "عساكم من عواده — كل عام وأنتم بخير" },
    color: "from-[#001a0a] via-[#020703] to-black"
  },
  {
    id: "eid_adha",
    name: { en: "Eid Al-Adha", ar: "عيد الأضحى المبارك" },
    date: "12-10",
    sticker: "🕋",
    desc: { en: "Festival of Sacrifice — May Allah accept your deeds", ar: "حفل الأضحى المبارك — تقبّل الله طاعتكم" },
    color: "from-[#221400] via-black to-[#110a00]"
  },
  {
    id: "saudi_national_day",
    name: { en: "Saudi National Day 96", ar: "اليوم الوطني السعودي ٩٦" },
    date: "09-23",
    sticker: "🇸🇦",
    desc: { en: "We Dream & Achieve — 96th National Day", ar: "همة حتى القمة — ٢٣ سبتمبر" },
    color: "from-[#001a0e] via-[#010805] to-black"
  }
];
...
const EVENT_META: Record<string, EventMeta> = {
  ramadan: {
    gradient: "linear-gradient(135deg, #0a0020 0%, #1a0040 30%, #000820 60%, #050015 100%)",
    glowColor: "#6b21a8",
    accentColor: "#c084fc",
    particleEmoji: ["🌙", "⭐", "✨", "🌟", "💫"],
    bgPattern: "radial-gradient(ellipse at 20% 20%, #6b21a860 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, #1e3a5f40 0%, transparent 50%)",
    headerEn: "Ramadan Kareem",
    headerAr: "رمضان كريم",
    subEn: "May this holy month fill your heart with peace, blessings & light",
    subAr: "رمضان شهر الخير والبركة والنور — كل عام وأنتم بخير",
    badgeEn: "Holy Month",
    badgeAr: "الشهر المبارك",
    icon: Moon,
  },
  eid_fitr: {
    gradient: "linear-gradient(135deg, #001a0e 0%, #003320 30%, #001208 60%, #000f05 100%)",
    glowColor: "#16a34a",
    accentColor: "#4ade80",
    particleEmoji: ["🎊", "🎉", "✨", "🌸", "🍬"],
    bgPattern: "radial-gradient(ellipse at 30% 30%, #16a34a50 0%, transparent 55%), radial-gradient(ellipse at 70% 70%, #ca8a0430 0%, transparent 50%)",
    headerEn: "Eid Mubarak",
    headerAr: "عيد مبارك",
    subEn: "Wishing you and your family a joyful and blessed Eid Al-Fitr",
    subAr: "عساكم من عواده — كل عام وأنتم بخير وعافية",
    badgeEn: "Eid Al-Fitr",
    badgeAr: "عيد الفطر",
    icon: Star,
  },
  eid_adha: {
    gradient: "linear-gradient(135deg, #1a0e00 0%, #2d1a00 30%, #0f0800 60%, #1a0800 100%)",
    glowColor: "#b45309",
    accentColor: "#fbbf24",
    particleEmoji: ["🕋", "🌙", "✨", "🐑", "🤲"],
    bgPattern: "radial-gradient(ellipse at 25% 25%, #b4530940 0%, transparent 55%), radial-gradient(ellipse at 75% 75%, #78350f30 0%, transparent 50%)",
    headerEn: "Eid Al-Adha Mubarak",
    headerAr: "عيد الأضحى المبارك",
    subEn: "May Allah accept your sacrifice and grant you His infinite blessings",
    subAr: "تقبّل الله طاعتكم وأدامكم بصحة وعافية",
    badgeEn: "Eid Al-Adha",
    badgeAr: "عيد الأضحى",
    icon: Globe,
  },
  saudi_national_day: {
    gradient: "linear-gradient(135deg, #001a0e 0%, #002d18 30%, #000f08 60%, #001a0a 100%)",
    glowColor: "#15803d",
    accentColor: "#4ade80",
    particleEmoji: ["🇸🇦", "🌴", "⭐", "✨", "👑"],
    bgPattern: "radial-gradient(ellipse at 20% 40%, #15803d50 0%, transparent 55%), radial-gradient(ellipse at 80% 60%, #15803d30 0%, transparent 50%)",
    headerEn: "Saudi National Day",
    headerAr: "اليوم الوطني السعودي",
    subEn: "96 years of Vision, Pride & Achievement — We Dream & We Achieve",
    subAr: "٩٦ عاماً من الإنجاز والطموح — همة حتى القمة",
    badgeEn: "September 23",
    badgeAr: "٢٣ سبتمبر",
    icon: Crown,
  },
};
...
/* =========================================================
   VALIDATION HELPERS
========================================================= */
const isValidPhone = (phone: string): boolean => /^[0-9+\s\-]{7,15}$/.test(phone.trim());
const isValidName = (name: string): boolean => name.trim().length >= 2;
const isValidPrice = (price: string): boolean => parseFloat(price) > 0 && isFinite(parseFloat(price));
const isValidKcal = (kcal: string): boolean => kcal === "" || (parseInt(kcal) >= 0 && isFinite(parseInt(kcal)));
const isValidWhatsapp = (num: string): boolean => /^[0-9]{7,15}$/.test(num.replace(/[\s+\-]/g, ""));
const isValidPin = (pin: string): boolean => /^\d{4}$/.test(pin.trim());
...
const printReceipt = (order: Order, lang: string) => {
  ...
  const itemsHtml = order.items.map(i => `
    <tr>
      <td style="padding:2px 8px;">${i.name}</td>
      <td style="padding:2px 8px; text-align:center;">x${i.qty}</td>
    </tr>`).join("");
  ...
  const deliveryInfo = order.method === "delivery" && order.deliveryAddress ? `
    <div class="row"><span>${lang === "ar" ? "العنوان" : "Address"}:</span><span>${order.deliveryAddress}</span></div>
    ${order.deliveryArea ? `<div class="row"><span>${lang === "ar" ? "الحي" : "Area"}:</span><span>${order.deliveryArea}</span></div>` : ""}
    ${order.deliveryLandmark ? `<div class="row"><span>${lang === "ar" ? "معلم قريب" : "Landmark"}:</span><span>${order.deliveryLandmark}</span></div>` : ""}
  ` : "";
  const html = `<!DOCTYPE html>
<html dir="${lang === "ar" ? "rtl" : "ltr"}">
<head><meta charset="UTF-8"/><title>Receipt #${order.id}</title>
<style>body{font-family:monospace;font-size:12px;width:300px;margin:0 auto;padding:16px;}h2{text-align:center;font-size:16px;margin-bottom:4px;}.sub{text-align:center;font-size:10px;color:#666;margin-bottom:12px;}table{width:100%;border-collapse:collapse;}.divider{border-top:1px dashed #000;margin:8px 0;}.row{display:flex;justify-content:space-between;padding:2px 0;}.total{font-weight:bold;font-size:14px;}.footer{text-align:center;margin-top:16px;font-size:10px;color:#888;}</style>
</head>
<body>
<h2>☕ Brew Café</h2>
<div class="sub">Madinah · VAT: 123456789 · ${date}</div>
<div class="divider"></div>
<table>${itemsHtml}</table>
<div class="divider"></div>
<div class="row"><span>${lang === "ar" ? "المجموع قبل الضريبة" : "Subtotal"}:</span><span>${subtotal.toFixed(2)} SAR</span></div>
<div class="row"><span>${lang === "ar" ? "ضريبة القيمة المضافة 15%" : "VAT 15%"}:</span><span>${vat.toFixed(2)} SAR</span></div>
<div class="divider"></div>
<div class="row total"><span>${lang === "ar" ? "الإجمالي" : "Total"}:</span><span>${order.total.toFixed(2)} SAR</span></div>
<div class="row"><span>${lang === "ar" ? "طريقة الدفع" : "Payment"}:</span><span>${order.paymentMethod}</span></div>
<div class="row"><span>${lang === "ar" ? "حالة الدفع" : "Payment Status"}:</span><span>${order.paymentStatus}</span></div>
<div class="divider"></div>
<div class="row"><span>${lang === "ar" ? "طريقة الاستلام" : "Method"}:</span><span>${order.method}</span></div>
${deliveryInfo}
${order.notes ? `<div class="row"><span>${lang === "ar" ? "ملاحظات" : "Notes"}:</span><span>${order.notes}</span></div>` : ""}
<div class="footer">${lang === "ar" ? "شكراً لزيارتكم · بريو كافيه" : "Thank you for visiting · Brew Café"}</div>
</body></html>`;
...
function MenuRowCarousel({
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={rowRef}
        className="flex gap-4 overflow-x-auto scrollbar-none px-4 pb-3 pt-1"
          ...
          >
            <div className="relative h-44 overflow-hidden bg-zinc-900">
              ...
              <div className="absolute top-3 ltr:left-3 rtl:right-3 ltr:right-3 rtl:left-3 flex justify-between items-start w-[calc(100%-24px)]">
                <span className="bg-black/70 backdrop-blur-md text-[9px] font-black text-[#d9ab7d] px-2.5 py-1 rounded-lg border border-[#d9ab7d]/20 uppercase tracking-wider shadow">
                  {item.badge}
                </span>
                {!item.inStock && (
                  <span className="bg-red-900/90 backdrop-blur-md text-white text-[9px] font-black px-2.5 py-1 rounded-lg border border-red-700 animate-pulse uppercase">
                    {lang === "ar" ? "نفذ" : "Out of Stock"}
                  </span>
                )}
              </div>
              <div className="absolute bottom-3 ltr:left-3 rtl:right-3">
                <span className="text-[9px] font-black uppercase tracking-widest text-zinc-400 bg-black/60 backdrop-blur-md px-2 py-0.5 rounded border border-white/5">
                  {item.cat}
                </span>
              </div>
            </div>
            <div className="p-4 flex-1 flex flex-col justify-between gap-3">
              <div>
                <div className="flex justify-between items-start gap-2 mb-1.5">
                  <h3 className="font-black text-[14px] text-white group-hover:text-[#d9ab7d] transition-colors leading-snug">
                    {item.name[lang as keyof LocalizedString]}
                  </h3>
                ...
                <p className="text-[11px] text-zinc-400 line-clamp-2 leading-relaxed">
                  {item.desc[lang as keyof LocalizedString]}
                </p>
              </div>
              <div className="flex items-center justify-between pt-3 border-t border-zinc-800/60">
                ...
                <button
                  ...
                  className={`h-9 w-9 rounded-xl flex items-center justify-center transition-all active:scale-90 shadow-md ${
                    !item.inStock
                      ? "bg-zinc-900 text-zinc-700 cursor-not-allowed"
                      : "bg-white text-black hover:bg-[#800020] hover:text-white cursor-pointer"
                  }`}
                >
                  <Plus size={17} />
                </button>
...
function EventCard({
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-3xl overflow-hidden border transition-all duration-500 cursor-pointer group ${
        isActive
          ? "border-white/20 shadow-2xl scale-[1.01]"
          : "border-zinc-800 hover:border-zinc-600 hover:scale-[1.005]"
      }`}
      style={{
        background: meta.gradient,
        boxShadow: isActive
          ? `0 0 60px ${meta.glowColor}50, 0 4px 30px rgba(0,0,0,0.8)`
    ...
    >
      <motion.div
        ...
        style={{ background: meta.bgPattern }}
      ...
      <div className="relative z-10 p-6">
        <div className="flex items-start justify-between mb-5">
          <div className="flex items-center gap-2">
            <div className="h-7 px-3 rounded-full text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5"
              style={{
                background: `${meta.glowColor}30`,
          ...
          {isActive && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="h-6 px-2.5 rounded-full bg-white/10 border border-white/20 text-[9px] font-black text-white flex items-center gap-1.5"
            >
              <motion.div
        ...
        <motion.div
          ...
          animate={isActive
            ? { rotate: [0, -5, 5, -3, 3, 0], scale: [1, 1.1, 1] }
            : { rotate: 0, scale: 1 }}
          transition={isActive
        ...
        <h3 className="text-2xl font-black text-white leading-tight mb-2 tracking-tight">
          {lang === "ar" ? meta.headerAr : meta.headerEn}
        </h3>
        ...
        <motion.button
          ...
          style={isActive
            ...
            : { background: meta.accentColor, color: "#000", boxShadow: `0 4px 20px ${meta.glowColor}60` }
          }
        >
          {isActive
            ? <><X size={13} /> {lang === "ar" ? "إلغاء تفعيل المظهر" : "Deactivate Theme"}</>
            : <><Sparkles size={13} /> {lang === "ar" ? "تفعيل المظهر الآن" : "Activate Theme"}</>
          }
        </motion.button>
      </div>
      {isActive && (
...
/* =========================================================
   ACTIVE EVENT FULL-PAGE OVERLAY BANNER
========================================================= */
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: `0 0 80px ${meta.glowColor}30, 0 4px 40px rgba(0,0,0,0.7)`,
      }}
    >
      ...
      <div className="relative z-10 px-6 py-8 sm:px-10 sm:py-10 flex flex-col sm:flex-row items-center gap-6">
        <div className="relative flex-shrink-0">
          ...
          <div className="absolute inset-0 blur-2xl opacity-40 pointer-events-none"
            style={{ background: meta.glowColor, borderRadius: "50%" }} />
        </div>
      ...
      <motion.div
        ...
        style={{ background: `linear-gradient(90deg, transparent, ${meta.accentColor}80, transparent)` }}
        animate={{ x: ["-100%", "100%"] }}
        transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
      />
    </motion.div>
...
export default function BrewCafeUltraElite() {
  ...
  const [newListing, setNewListing] = useState<NewListingState>({
    ...
    price: "", kcal: "", cat: "hot", badge: "New", imgUrl: ""
  });

  const [pin, setPin] = useState<string>("");
  const [ownerPin, setOwnerPin] = useState<string>("1234");
  const [superAdminPinInput, setSuperAdminPinInput] = useState<string>("");
  const [isSuperAdminVerified, setIsSuperAdminVerified] = useState<boolean>(false);
  const [pinChangeInput, setPinChangeInput] = useState<string>("");
  const [pinError, setPinError] = useState<string>("");
  const [whatsappNumber, setWhatsappNumber] = useState<string>("966502013071");
  const [isPinRecoveryOpen, setIsPinRecoveryOpen] = useState<boolean>(false);
  const [toasts, setToasts] = useState<ToastMessage[]>([]);
  const isPlacingOrderRef = useRef<boolean>(false);

  const [bgIndex, setBgIndex] = useState<number>(0);
  const [sidebarOpen, setSidebarOpen] = useState<boolean>(true);
  const [timerPopup, setTimerPopup] = useState<boolean>(false);
  const [currentTime, setCurrentTime] = useState<Date>(new Date());
  const [activeEvent, setActiveEvent] = useState<IslamicEvent | null>(null);

  const [cart, setCart] = useState<CartItem[]>([]);
  const [customerInfo, setCustomerInfo] = useState<CustomerInfo>({
    name: "", phone: "", method: "pickup", notes: "", paymentMethod: "cash",
    deliveryAddress: "", deliveryArea: "", deliveryLandmark: "",
  });
  ...
  const [staffFilter, setStaffFilter] = useState<string>("active");
  ...
  const switchView = useCallback((v: string) => {
    if (v !== "customer") {
      setCart([]);
      setCustomerInfo({ name: "", phone: "", method: "pickup", notes: "", paymentMethod: "cash", deliveryAddress: "", deliveryArea: "", deliveryLandmark: "" });
      setCartErrors({});
      setIsCartOpen(false);
    }
    setView(v);
  ...
  const showToast = useCallback((text: string, type: "success" | "error" | "info" = "success", dedupeKey?: string) => {
    ...
    setToasts(prev => {
      ...
      return [...trimmed, { id, text, type }];
    });
    setTimeout(() => setToasts(prev => prev.filter(t => t.id !== id)), 3000);
  }, []);

  useEffect(() => {
    const t = setInterval(() => setHeroIndex(p => (p + 1) % BREW_GALLERY.length), 4000);
  ...
  useEffect(() => {
    async function initializeAppEngine() {
      setIsSyncing(true);
      try {
        const { data: menuCloudData, error: menuError } = await supabase
          .from('brew_cafe_menu').select('*').order('id', { ascending: true });
        if (!menuError && menuCloudData && menuCloudData.length > 0) {
          setMenuData(menuCloudData as MenuItem[]);
        } else if (menuError) {
          console.warn("Menu fetch failed, using local fallback:", menuError.message);
          setMenuData(INITIAL_MENU);
        }
        const { data: ordersCloudData, error: ordersError } = await supabase
          .from('brew_cafe_orders').select('*').order('created_at', { ascending: false });
        if (!ordersError && ordersCloudData) {
          setOrders(ordersCloudData as Order[]);
          setDbStatus("Connected Successfully!");
        } else {
          if (ordersError) console.warn("Orders fetch error:", ordersError.message);
          setDbStatus("Connection Failed");
        }
        try {
          const localPastOrders = localStorage.getItem("brew_cafe_past_orders");
          if (localPastOrders) setPastOrders(JSON.parse(localPastOrders));
        } catch { /* ignore */ }
        ...
        if (settingsData) {
          ...
          if (evRow && evRow.value) {
            const foundEv = ISLAMIC_EVENTS.find(e => e.id === evRow.value);
            if (foundEv) setActiveEvent(foundEv);
          }
          const promoRow = settingsData.find((s: { key: string; value: string }) => s.key === 'promo_block');
          if (promoRow && promoRow.value) {
            try {
              const parsed = JSON.parse(promoRow.value);
              setPromoBlock(parsed); setPromoEdit(parsed);
            } catch { /* ignore */ }
          }
        }
        setIsLoaded(true);
    ...
    const liveStreamChannel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'brew_cafe_orders' }, (payload) => {
        if (payload.eventType === 'INSERT') {
          setOrders(prev =>
            prev.some(o => o.id === (payload.new as Order).id)
              ? prev : [payload.new as Order, ...prev]
          );
          if (view === "staff") playOrderPing();
  ...
  useEffect(() => {
    if (!isLoaded) return;
    try { localStorage.setItem("brew_cafe_past_orders", JSON.stringify(pastOrders.slice(0, 50))); } catch { /* incognito */ }
  }, [pastOrders, isLoaded]);

  useEffect(() => {
    if (!isLoaded || !ownerPin) return;
    supabase.from('brew_cafe_settings')
      .upsert({ key: 'owner_pin', value: ownerPin }, { onConflict: 'key' })
      .then(({ error }) => { if (error) console.error('PIN save error:', error); });
  }, [ownerPin, isLoaded]);
  ...
  useEffect(() => {
    ...
    supabase.from('brew_cafe_settings')
      ...
      .then(({ error }) => { if (error) console.error('WhatsApp save error:', error); });
  }, [whatsappNumber, isLoaded]);

  useEffect(() => {
    if (!isLoaded) return;
    supabase.from('brew_cafe_settings')
      .upsert({ key: 'active_event', value: activeEvent?.id || '' }, { onConflict: 'key' })
      .then(({ error }) => { if (error) console.error('Event save error:', error); });
  }, [activeEvent, isLoaded]);

  useEffect(() => {
    if (!isLoaded) return;
    supabase.from('brew_cafe_settings')
      .upsert({ key: 'promo_block', value: JSON.stringify(promoBlock) }, { onConflict: 'key' })
      .then(({ error }) => { if (error) console.error('Promo save error:', error); });
  }, [promoBlock, isLoaded]);
  ...
  useEffect(() => {
    const interval = setInterval(() => setBgIndex(prev => (prev + 1) % COLORS.length), 15000);
    return () => clearInterval(interval);
  }, []);

  const verifyPin = useCallback(async (inputPin: string) => {
    const trimmed = inputPin.trim();
    if (!isValidPin(trimmed)) return;
    setIsSyncing(true);
    await new Promise(res => setTimeout(res, 300));
    if (trimmed === ownerPin) {
      switchView("hub"); setPin(""); setPinError("");
      showToast("Access granted.", "success", "pin-grant");
    } else {
      setPinError(lang === "ar" ? "الرمز غير صحيح" : "Incorrect PIN.");
      setPin(""); showToast("Incorrect PIN. Try again.", "error", "pin-error");
    }
    setIsSyncing(false);
  ...
  const addToCart = useCallback((item: MenuItem) => {
    if (!item.inStock) {
      showToast(lang === "ar" ? "هذا المنتج غير متوفر حالياً" : "This item is currently out of stock.", "error", `oos-${item.id}`);
      return;
    }
    setCart(prev => {
      ...
      if (exist) {
        if (exist.qty >= 20) {
          showToast(lang === "ar" ? "الحد الأقصى 20 قطعة" : "Maximum 20 per item.", "info", `max-${item.id}`);
          return prev;
        }
    ...
    showToast(
      lang === "ar" ? "تمت الإضافة إلى الحقيبة" : `${item.name[lang as keyof LocalizedString]} added to bag.`,
      "success", `added-${item.id}`
    );
  }, [lang, showToast]);
  ...
  const updateQty = useCallback((id: number, delta: number) => {
    setCart(prev => prev.map(i => {
      if (i.id !== id) return i;
      if (delta > 0 && i.qty >= 20) {
        showToast(lang === "ar" ? "الحد الأقصى 20 قطعة" : "Maximum 20 per item.", "info", `max-${id}`);
        return i;
      }
  ...
  const deleteFromMenu = async (id: number) => {
    ...
    if (!error) {
      ...
      showToast(lang === "ar" ? "تم حذف المنتج بنجاح" : "Product deleted successfully.", "success", "menu-delete");
    } else {
      showToast(lang === "ar" ? "فشل الحذف — تحقق من صلاحيات Supabase RLS" : "Failed to delete. Check Supabase RLS policy.", "error", "menu-delete-fail");
    }
    setIsSyncing(false);
  };
  ...
  const validateCartForm = (): boolean => {
    ...
    if (customerInfo.method === "delivery" && customerInfo.deliveryAddress.trim().length < 5)
      errors.deliveryAddress = lang === "ar" ? "العنوان مطلوب للتوصيل" : "Delivery address is required";
  ...
  const placeOrder = async () => {
    ...
    const deliveryBlock = customerInfo.method === "delivery"
      ? `\n📍 ${lang === "ar" ? "العنوان" : "Address"}: ${customerInfo.deliveryAddress.trim()}`
        + (customerInfo.deliveryArea.trim() ? `\n🏘 ${lang === "ar" ? "الحي" : "Area"}: ${customerInfo.deliveryArea.trim()}` : "")
        + (customerInfo.deliveryLandmark.trim() ? `\n🏢 ${lang === "ar" ? "معلم قريب" : "Landmark"}: ${customerInfo.deliveryLandmark.trim()}` : "")
      : "";
    ...
    const newOrder = {
      customer: customerInfo.name.trim(), phone: customerInfo.phone.trim(),
      method: customerInfo.method,
      items: cart.map(i => ({ name: i.name.en, qty: i.qty })),
      total, status: "Queued", created_at: Date.now(),
      notes: customerInfo.notes.trim().slice(0, 200), previousStatus: null,
      ...
      deliveryArea: customerInfo.deliveryArea.trim() || null,
      deliveryLandmark: customerInfo.deliveryLandmark.trim() || null,
    };

    try {
      const { data: insertedData, error } = await supabase
        .from('brew_cafe_orders').insert([newOrder]).select().single();
      if (!error && insertedData) {
        const savedOrder = insertedData as Order;
        setPastOrders(prev => [savedOrder, ...prev]);
        const soldUpdates = cart.map(cartItem =>
          supabase.from('brew_cafe_menu')
            .update({ sold: (menuData.find(m => m.id === cartItem.id)?.sold || 0) + cartItem.qty })
            .eq('id', cartItem.id)
        );
        await Promise.all(soldUpdates);
        setMenuData(prev => prev.map(m => {
          const ci = cart.find(c => c.id === m.id);
          return ci ? { ...m, sold: m.sold + ci.qty } : m;
        }));
        ...
        showToast(
          error?.message?.includes("policy") || error?.code === "42501"
            ? "Order failed: Supabase RLS policy blocks inserts. Enable anon insert on brew_cafe_orders."
            : "Failed to place order. Please check your connection.",
          "error", "order-fail"
        );
      }
    } catch {
      showToast("An unexpected error occurred. Please try again.", "error", "order-error");
    } finally {
  ...
  const updateOrderStatusCloud = async (orderId: number, updatedStatus: string, previousStatusValue: string | null = null) => {
    setIsSyncing(true);
    const { error } = await supabase.from('brew_cafe_orders')
      .update({ status: updatedStatus, previousStatus: previousStatusValue }).eq('id', orderId);
    if (!error) {
      setOrders(prev => prev.map(o => o.id === orderId ? { ...o, status: updatedStatus, previousStatus: previousStatusValue } : o));
      showToast(`Status updated to ${updatedStatus}.`, "success", `status-${orderId}`);
    } else {
      showToast("Status update failed.", "error", `status-fail-${orderId}`);
    }
    setIsSyncing(false);
  };
  ...
  const updatePaymentStatus = async (orderId: number, newPaymentStatus: PaymentStatus) => {
    setIsSyncing(true);
    const { error } = await supabase.from('brew_cafe_orders')
      .update({ paymentStatus: newPaymentStatus }).eq('id', orderId);
    if (!error) {
      setOrders(prev => prev.map(o => o.id === orderId ? { ...o, paymentStatus: newPaymentStatus } : o));
      showToast(`Payment marked as ${newPaymentStatus}.`, "success", `pay-${orderId}`);
    } else {
      showToast("Payment update failed.", "error", `pay-fail-${orderId}`);
    }
    setIsSyncing(false);
  };
    ...
    try {
      ...
      showToast(
        e?.message?.includes("policy") || e?.code === "42501"
          ? "Stock update failed: Check Supabase RLS policy for brew_cafe_menu."
          : "Stock update failed.",
        "error", `stock-fail-${itemId}`
      );
  ...
  const handleStorageBucketImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsUploading(true);
    showToast("Uploading image...", "info", "upload-start");
    try {
      const ext = imageFile.name.split('.').pop();
      const fileName = `${Date.now()}-${Math.random().toString(36).substring(2)}.${ext}`;
      const { error: storageError } = await supabase.storage
        .from('brew-cafe-images').upload(fileName, imageFile, { cacheControl: '3600', upsert: false });
      if (storageError) throw storageError;
      const { data: publicUrlData } = supabase.storage.from('brew-cafe-images').getPublicUrl(fileName);
      if (publicUrlData?.publicUrl) {
        setNewListing(prev => ({ ...prev, imgUrl: publicUrlData.publicUrl }));
        showToast("Image uploaded successfully!", "success", "upload-ok");
      }
    } catch (err: unknown) {
      const e = err as { message?: string; statusCode?: number };
      const msg = e?.message?.includes("policy") || e?.message?.includes("Unauthorized") || e?.statusCode === 403
        ? "Storage permission error. In Supabase: Storage → brew-cafe-images → Policies → allow anon uploads."
        : "Image upload failed.";
      showToast(msg, "error", "upload-fail");
  ...
  const deployProductListing = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!validateNewListing()) return;
    setIsSyncing(true);
    const defaultImage = "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?q=80&w=1400&auto=format&fit=crop";
    const newItem = {
      badge: newListing.badge || "New",
      type: newListing.cat === "dessert" ? "Dessert" : newListing.cat === "cold" ? "Cold" : "Hot",
      name: { en: newListing.nameEn.trim(), ar: newListing.nameAr.trim() },
      desc: { en: newListing.descEn.trim() || "Artisanal Brew selection.", ar: newListing.descAr.trim() || "خيارات بريو الفاخرة." },
      price: parseFloat(newListing.price), kcal: parseInt(newListing.kcal) || 0,
      cat: newListing.cat, sold: 0, img: newListing.imgUrl?.trim() || defaultImage, inStock: true
    };
    const { data: insertedItem, error } = await supabase.from('brew_cafe_menu').insert([newItem]).select().single();
    if (!error && insertedItem) {
      setMenuData(prev => [...prev, insertedItem as MenuItem]);
      setIsDeployModalOpen(false);
      setNewListing({ nameEn: "", nameAr: "", descEn: "", descAr: "", price: "", kcal: "", cat: "hot", badge: "New", imgUrl: "" });
      setListingErrors({});
      showToast("Product deployed successfully!", "success", "deploy-ok");
    } else {
      showToast(
        error?.message?.includes("policy") || error?.code === "42501"
          ? "Failed: Supabase RLS blocks insert on brew_cafe_menu. Add anon INSERT policy."
  ...
  const handleClearLiveDashboardCache = async () => {
    ...
    if (!error) {
      ...
      try { localStorage.removeItem("brew_cafe_past_orders"); } catch { /* ignore */ }
      showToast("All orders have been cleared.", "success", "orders-cleared");
  ...
  const activeCustomerOrders = useMemo(() =>
    pastOrders.filter(p => {
      ...
      const status = live?.status || p.status;
  ...
  const staffVisibleOrders = useMemo(() => {
    ...
    return [...list].sort((a, b) => {
      ...
      const aLate = (Date.now() - a.created_at) > 300000 ? -1 : 0;
      const bLate = (Date.now() - b.created_at) > 300000 ? -1 : 0;
      return aLate - bLate;
    });
  }, [orders, staffFilter]);
  ...
  const filteredOwnerOrders = useMemo(() => {
    return orders.filter(o => {
      ...
      const fromTs = orderDateFrom ? new Date(orderDateFrom).getTime() : 0;
      const toTs = orderDateTo ? new Date(orderDateTo + "T23:59:59").getTime() : Infinity;
      const matchDate = o.created_at >= fromTs && o.created_at <= toTs;
  ...
  return (
    ...
    >
        ...
        <AnimatePresence>
          {toasts.map(toast => (
            <motion.div key={toast.id}
              ...
              className={`p-4 rounded-xl border backdrop-blur-md shadow-2xl pointer-events-auto flex items-center gap-2.5 ${
      ...
      <AnimatePresence>
        {showClearConfirm && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            className="fixed inset-0 z-[900] bg-black/80 flex items-center justify-center p-4">
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }}
              className="bg-zinc-950 border border-red-800 rounded-2xl p-6 max-w-sm w-full text-center">
              ...
              <div className="flex gap-3">
                <button type="button" onClick={() => setShowClearConfirm(false)}
                  className="flex-1 h-10 rounded-xl bg-zinc-800 text-white text-xs font-black uppercase cursor-pointer hover:bg-zinc-700 transition-colors">
                  {lang === "ar" ? "إلغاء" : "Cancel"}
                </button>
                <button type="button" onClick={handleClearLiveDashboardCache}
                  className="flex-1 h-10 rounded-xl bg-red-700 text-white text-xs font-black uppercase cursor-pointer hover:bg-red-600 transition-colors">
                  {lang === "ar" ? "نعم، احذف الكل" : "Yes, Delete All"}
                </button>
              </div>
            </motion.div>
          </motion.div>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        {activeEvent && (
          <div className="absolute top-44 ltr:right-12 rtl:left-12 text-[10rem] opacity-5 select-none font-black filter blur-[2px]" dir="ltr">
            {activeEvent.sticker}
          </div>
        )}
      </div>
        ...
        {timerPopup && (
          <motion.div initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -40 }}
            ...
            <p className="text-sm font-medium text-zinc-300 leading-relaxed">
              {lang === "ar" ? "نهتم بوقتكم — كل طلب يُتابع بأعلى معايير السرعة والجودة." : "We care about your time. Every order is tracked and prepared with maximum speed and quality."}
            </p>
            <button type="button" onClick={() => setTimerPopup(false)}
              className="mt-5 text-[10px] font-black tracking-widest bg-white/10 px-5 py-2 rounded-full text-white hover:bg-[#800020] transition-all uppercase">
          ...
          <motion.main key="customer" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="relative h-[55vh] sm:h-[65vh] overflow-hidden mb-0">
              {BREW_GALLERY.map((img, idx) => (
                <motion.div key={idx}
                  initial={{ opacity: 0 }} animate={{ opacity: idx === heroIndex ? 1 : 0 }}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
                <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
                  ...
                  {lang === "ar" ? "قهوة مختصة فاخرة · تجربة استثنائية" : "Specialty Coffee Roasters · Madinah"}
                </motion.p>
                <motion.h2 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
                  className="text-4xl sm:text-6xl lg:text-8xl font-black tracking-tighter leading-none mb-5">
                  {lang === "ar" ? "شغف الحبة" : "Crafted For"}<br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d9ab7d] via-zinc-100 to-[#b8895f] italic">
                    {lang === "ar" ? "فخامة التقديم" : "Quiet Luxury"}
                  </span>
                </motion.h2>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-black/50 backdrop-blur-md border-t border-white/5 py-3 px-6 z-10">
                <div className="max-w-4xl mx-auto flex items-center justify-center gap-4 sm:gap-10 flex-wrap">
                  {[
                    ...
                    { icon: "🪑", en: "Dine-in & Takeaway", ar: "داخلي وخارجي" },
                    { icon: "🅿️", en: "Free Parking", ar: "موقف مجاني" },
                  ].map((item, i) => (
                    <div key={i} className="flex items-center gap-1.5 text-[10px] text-zinc-300 font-bold">
                      <span>{item.icon}</span>
            ...
            <div id="menu-section" className="px-4 sm:px-6 lg:px-8 pt-4">
                ...
                {promoBlock.active && (
                  ...
                  >
                    <div className="relative rounded-3xl overflow-hidden"
                      style={{
                        background: `linear-gradient(135deg, ${promoBlock.bgColor}e0 0%, #0d0d0d 55%, ${promoBlock.bgColor}30 100%)`,
              ...
              <div className="mb-4">
                <div className="w-full bg-zinc-900/80 border border-zinc-800 rounded-2xl px-5 flex items-center gap-3 h-12 sm:h-14 focus-within:border-zinc-600 transition-colors">
                  ...
                  {search && (
                    <button type="button" onClick={() => setSearch("")} className="text-zinc-500 hover:text-white flex-shrink-0 transition-colors">
                      <X size={16} />
                    </button>
                  )}
                </div>
              ...
              <section className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl p-5 border border-zinc-800 bg-zinc-950/40 backdrop-blur-md">
                  ...
                  <a href="https://maps.app.goo.gl/u6i4p214iJBuzxKTA" target="_blank" rel="noreferrer"
                    className="inline-flex h-9 px-4 items-center bg-zinc-900 hover:bg-[#800020] text-white text-[10px] font-black uppercase tracking-widest rounded-lg transition-colors">
                    {lang === "ar" ? "فتح خرائط جوجل" : "Navigate via GPS"}
                  </a>
                </div>
                <div className="rounded-2xl p-5 border border-zinc-800 bg-zinc-950/40 backdrop-blur-md flex flex-col justify-between">
                  ...
                  <a href={`https://wa.me/${whatsappNumber.replace(/[^0-9]/g, '')}`}
                    className="inline-flex h-9 px-4 items-center bg-emerald-600/20 border border-emerald-500/30 text-emerald-400 text-[10px] font-black uppercase tracking-widest rounded-lg hover:bg-emerald-600 hover:text-white transition-all max-w-max">
                    {lang === "ar" ? "تواصل معنا" : "Chat Now"}
                  </a>
                </div>
              </section>
              ...
              <footer className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 select-none">
                <p onClick={() => switchView("login")}
                  className="text-xs text-zinc-600 font-medium cursor-pointer hover:text-zinc-400 transition-colors">
                  {lang === "ar" ? "حقوق الطبع © 2026 بريو كافيه. جميع الحقوق محفوظة." : "© 2026 Brew Café. All Rights Reserved."}
                </p>
              </footer>
            </div>
          </motion.main>
        ...
        {view === "login" && (
          <motion.div key="login" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="w-full max-w-sm rounded-3xl border border-zinc-800 bg-zinc-900/40 p-6 sm:p-8 text-center shadow-2xl">
              ...
              <input autoFocus type="password" maxLength={4} value={pin}
                onChange={e => { setPin(e.target.value); setPinError(""); }}
                placeholder="••••"
                className={`w-full h-14 rounded-xl bg-black border text-center text-3xl font-mono tracking-[0.5em] text-white outline-none ${
                  pinError ? "border-red-600 focus:border-red-500" : "border-zinc-800 focus:border-[#800020]"
                }`} />
              {pinError && <p className="mt-2 text-red-400 text-xs font-bold">{pinError}</p>}
              <div className="mt-4 text-center">
                <button type="button" onClick={() => setIsPinRecoveryOpen(!isPinRecoveryOpen)}
                  className="text-[10px] text-zinc-400 hover:text-[#d9ab7d] flex items-center justify-center gap-1 mx-auto">
                  <HelpCircle size={11} />
                  <span>{lang === "ar" ? "نسيت الرمز السري؟" : "Forgot your PIN?"}</span>
                </button>
                {isPinRecoveryOpen && (
                  <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }}
                    className="mt-2 p-3 bg-black/40 rounded-lg border border-zinc-800 text-[10px] text-zinc-400 leading-relaxed">
              ...
              <button type="button" onClick={() => switchView("customer")}
                className="mt-6 text-[10px] uppercase tracking-widest font-black text-zinc-500 hover:text-white transition-colors block mx-auto cursor-pointer">
                ...
                {!isSuperAdminVerified ? (
                  <div className="space-y-2 pt-2 border-t border-zinc-800">
                    ...
                    <div className="flex gap-2">
                      <input type="password" placeholder="••••" maxLength={4} value={superAdminPinInput}
                        onChange={e => setSuperAdminPinInput(e.target.value)}
                        className="h-10 w-24 rounded-lg bg-black border border-zinc-800 text-center font-mono text-xs tracking-widest text-white outline-none" />
                      <button type="button"
                        onClick={() => {
                          if (superAdminPinInput === ownerPin) {
                            setIsSuperAdminVerified(true); switchView("owner"); setSuperAdminPinInput("");
                          } else { showToast("Incorrect PIN.", "error", "hub-pin-fail"); setSuperAdminPinInput(""); }
                        }}
                        className="h-10 px-4 rounded-lg bg-[#800020] text-white text-[10px] font-black uppercase tracking-wider flex-1 cursor-pointer">
                        {lang === "ar" ? "تحقّق" : "Verify"}
                      </button>
                    </div>
                  </div>
                ) : (
                  <button type="button" onClick={() => switchView("owner")}
                    className="h-10 rounded-lg bg-emerald-600 text-white text-[10px] font-black uppercase tracking-widest cursor-pointer">
                    {lang === "ar" ? "دخول لوحة التحكم" : "Enter Dashboard"}
                  </button>
                )}
              </div>
              <button type="button" onClick={() => { switchView("customer"); setIsSuperAdminVerified(false); }}
                className="md:col-span-2 h-11 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-black tracking-widest text-zinc-400 hover:text-white uppercase transition-colors cursor-pointer">
                {lang === "ar" ? "العودة إلى القائمة" : "Return to Menu"}
              </button>
            </div>
          </motion.div>
        )}
        ...
        {view === "staff" && (
          <motion.main key="staff" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button type="button" onClick={() => switchView("hub")} className="h-10 px-4 rounded-xl bg-zinc-900 border border-zinc-800 text-xs font-bold hover:bg-zinc-800 cursor-pointer">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4 text-center">
              {ORDER_STATUSES.map(st => {
                ...
                const labels: Record<string, { en: string; ar: string }> = {
                  Queued: { en: "Queued", ar: "انتظار" }, Preparing: { en: "Preparing", ar: "تحضير" },
                  Ready: { en: "Ready", ar: "جاهز" }, Cancelled: { en: "Cancelled", ar: "ملغي" }, Delivered: { en: "Delivered", ar: "مكتمل" },
                };
                return (
            ...
            <div className="flex gap-1.5 mb-5 overflow-x-auto scrollbar-none pb-1">
              {[
                ...
                { key: "Queued", en: "Queued", ar: "انتظار" },
                { key: "Preparing", en: "Preparing", ar: "تحضير" },
                { key: "Ready", en: "Ready", ar: "جاهز" },
                { key: "all", en: "All", ar: "الكل" },
              ].map(f => (
                <button key={f.key} type="button" onClick={() => setStaffFilter(f.key)}
                  className={`h-9 px-4 rounded-xl text-[10px] font-black uppercase tracking-wider flex-shrink-0 transition-all cursor-pointer border ${
                    staffFilter === f.key ? "bg-[#800020] border-[#800020] text-white" : "bg-zinc-900/60 border-zinc-800 text-zinc-400 hover:bg-zinc-800 hover:text-white"
                  }`}>
                  {lang === "ar" ? f.ar : f.en}
                </button>
              ))}
              {lateOrdersCount > 0 && (
                <div className="h-9 px-4 rounded-xl bg-red-950/40 border border-red-800 text-red-400 text-[10px] font-black flex items-center gap-1.5 flex-shrink-0 animate-pulse">
                  <AlertTriangle size={11} /> {lateOrdersCount} {lang === "ar" ? "متأخر" : "Late"}
                </div>
              )}
            </div>
            {/* Orders list */}
            <div className="space-y-4">
              {staffVisibleOrders.map(order => {
                ...
                const statusLabels: Record<string, { en: string; ar: string }> = {
                  Queued: { en: "Queued", ar: "انتظار" }, Preparing: { en: "Preparing", ar: "تحضير" },
                  Ready: { en: "Ready", ar: "جاهز" }, Cancelled: { en: "Cancelled", ar: "ملغي" }, Delivered: { en: "Delivered", ar: "مسلّم" },
                };
                const cardBorder = isDelayed ? "border-red-800/60 bg-red-950/10"
                  : order.status === "Ready" ? "border-emerald-800/40 bg-emerald-950/10"
                  : order.status === "Preparing" ? "border-blue-800/40 bg-blue-950/10"
                  : order.status === "Cancelled" ? "bg-zinc-950/20 border-zinc-900 opacity-60"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-bold text-white px-2 py-0.5 rounded bg-zinc-800 capitalize">
                            {statusLabels[order.status]?.[lang as "en" | "ar"] || order.status}
                          </span>
                          ...
                          <span className={`text-[9px] px-2 py-0.5 rounded font-black uppercase ${
                            order.paymentStatus === "paid" ? "bg-emerald-950 text-emerald-400 border border-emerald-800"
                              : order.paymentStatus === "refunded" ? "bg-zinc-900 text-zinc-400 border border-zinc-700"
                              : "bg-amber-950 text-amber-400 border border-amber-800"
                          }`}>
                            {order.paymentMethod?.toUpperCase()} · {order.paymentStatus?.toUpperCase()}
                          </span>
                          <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-mono font-black ${
                            isDelayed ? "bg-red-500/20 text-red-400 border border-red-500/30 animate-pulse" : "bg-[#800020]/30 text-zinc-300 border border-[#800020]/40"
                          }`}>
                        ...
                        <div className="space-y-1 my-3">
                          {order.items.map((it, idx) => <p key={idx} className="text-base font-black text-white">{it.qty}x {it.name}</p>)}
                        </div>
                        <div className="flex flex-wrap items-center gap-3 text-[11px] text-zinc-500 font-medium">
                          <span>🚚 <strong className="text-zinc-300 capitalize">
                            {order.method === "pickup" ? (lang === "ar" ? "استلام" : "Pickup") : (lang === "ar" ? "توصيل" : "Delivery")}
                          </strong></span>
                          {order.method === "delivery" && order.deliveryAddress && (
                            <span className="text-blue-400 text-[10px]">
                              📍 {order.deliveryAddress}{order.deliveryArea ? ` · ${order.deliveryArea}` : ""}{order.deliveryLandmark ? ` · ${order.deliveryLandmark}` : ""}
                            </span>
                          )}
                      ...
                      <div className="flex flex-wrap sm:flex-col items-end gap-2 pt-3 sm:pt-0 border-t sm:border-t-0 border-zinc-800">
                        <div className="flex flex-wrap gap-1.5">
                          {order.status === "Queued" && (
                            <button type="button" onClick={() => updateOrderStatusCloud(order.id, "Preparing")}
                              className="h-9 px-3 rounded-lg bg-amber-500 text-black text-[10px] font-black uppercase tracking-wider cursor-pointer">
                              {lang === "ar" ? "تحضير" : "PREPARE"}
                            </button>
                          )}
                          {order.status !== "Ready" && order.status !== "Delivered" && order.status !== "Cancelled" && (
                            <button type="button" onClick={() => updateOrderStatusCloud(order.id, "Ready")}
                              className="h-9 px-3 rounded-lg bg-white text-black text-[10px] font-black uppercase tracking-wider cursor-pointer">
                              {lang === "ar" ? "جاهز" : "READY"}
                            </button>
                          )}
                          {order.status !== "Cancelled" && order.status !== "Delivered" && (
                            <button type="button" onClick={() => updateOrderStatusCloud(order.id, "Cancelled", order.status)}
                              className="h-9 px-3 rounded-lg bg-red-950/60 border border-red-800 text-red-400 text-[10px] font-black uppercase tracking-wider cursor-pointer">
                              {lang === "ar" ? "إلغاء" : "CANCEL"}
                            </button>
                          )}
                          {order.status === "Cancelled" ? (
                            <button type="button" onClick={() => updateOrderStatusCloud(order.id, order.previousStatus || "Queued", null)}
                              className="h-9 px-3 rounded-lg bg-zinc-800 border border-zinc-700 text-[#d9ab7d] text-[10px] font-black uppercase tracking-wider flex items-center gap-1 hover:bg-zinc-700 transition-colors cursor-pointer">
                          ...
                          {order.paymentMethod === "cash" && order.paymentStatus === "pending" && (
                            <button type="button" onClick={() => updatePaymentStatus(order.id, "paid")}
                              className="h-9 px-3 rounded-lg bg-emerald-950 border border-emerald-800 text-emerald-400 text-[10px] font-black uppercase tracking-wider cursor-pointer flex items-center gap-1">
                              <CheckCircle2 size={12} /> {lang === "ar" ? "استلمت الكاش" : "CASH RECEIVED"}
                            </button>
                          )}
                          <button type="button" onClick={() => printReceipt(order, lang)}
                            className="h-9 px-3 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-400 text-[10px] font-black uppercase tracking-wider cursor-pointer flex items-center gap-1 hover:text-white hover:bg-zinc-700 transition-colors">
              ...
              {staffVisibleOrders.length === 0 && (
                <div className="text-center py-16 text-zinc-600">
                  <ChefHat size={40} className="mx-auto mb-3 opacity-30" />
                  <p className="text-sm font-bold">{lang === "ar" ? "لا توجد طلبات في هذه الفئة" : "No orders in this category."}</p>
                </div>
              )}
            </div>
          </motion.main>
            ...
            <aside className={`border-b lg:border-b-0 ${lang === "ar" ? "lg:border-l lg:border-r-0" : "lg:border-r lg:border-l-0"} border-zinc-800 bg-zinc-950/80 backdrop-blur-md transition-all duration-300 flex-shrink-0 w-full lg:block ${sidebarOpen ? "lg:w-56" : "lg:w-16"}`}>
              ...
              <div className="p-2 flex flex-row lg:flex-col overflow-x-auto lg:overflow-x-visible gap-1 pb-3 lg:pb-6 scrollbar-none">
                {[
                  ...
                  { key: "menu", icon: Database, labelEn: "Menu", labelAr: "المنيو" },
                  { key: "promo", icon: Megaphone, labelEn: "Promotions", labelAr: "العروض" },
                  { key: "events", icon: Calendar, labelEn: "Events", labelAr: "المناسبات" },
                  { key: "settings", icon: Settings, labelEn: "Settings", labelAr: "الإعدادات" }
                ].map(tab => {
                  const Icon = tab.icon;
                  return (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div className="p-5 rounded-2xl bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 flex flex-col justify-between min-h-[185px] relative overflow-hidden sm:col-span-2 xl:col-span-1">
                      ...
                      <div className="flex flex-wrap gap-1 my-2 bg-black/50 p-1 rounded-xl border border-zinc-900/80">
                        {[
                          { key: "today", en: "Today", ar: "اليوم" }, { key: "week", en: "Week", ar: "أسبوع" },
                          { key: "month", en: "Month", ar: "شهر" }, { key: "6months", en: "6M", ar: "٦ش" },
                          { key: "1year", en: "1Y", ar: "سنة" }, { key: "all", en: "All", ar: "الكل" }
                        ].map(period => (
                          <button key={period.key} type="button" onClick={() => setRevenuePeriod(period.key)}
                            className={`text-[8px] font-black uppercase tracking-tight px-1 py-1 rounded-lg transition-all flex-1 text-center cursor-pointer ${
                              revenuePeriod === period.key ? "bg-[#800020] text-white shadow-md scale-105" : "text-zinc-500 hover:text-zinc-300 hover:bg-zinc-900/50"
                            }`}>
                            {lang === "ar" ? period.ar : period.en}
                          </button>
                        ))}
                      </div>
                      <div className="min-h-[38px]">
                        <AnimatePresence mode="wait">
                          <motion.div key={revenuePeriod + netRevenue}
                            initial={{ opacity: 0, y: 3 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -3 }}
                            transition={{ duration: 0.15 }}>
                            <h3 className="text-2xl font-black text-white tracking-tight flex items-baseline gap-1">
                              {netRevenue.toFixed(2)}<span className="text-xs text-zinc-500 font-bold uppercase">SAR</span>
                            </h3>
                          </motion.div>
                        </AnimatePresence>
                        <p className="text-[10px] text-zinc-400 mt-1 flex items-center gap-1">
                          <TrendingUp size={10} className="text-emerald-400" />
                          {lang === "ar" ? "الصافي بعد الملغي" : "Net after cancelled orders"}
                        </p>
                      </div>
                      <div className="pt-2 border-t border-zinc-800/60 flex justify-between text-[10px] text-zinc-500 font-bold">
                        <span>G: <span className="font-mono text-zinc-300">{grossRevenue.toFixed(0)}</span></span>
                    ...
                    <div className="p-5 rounded-2xl bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 flex flex-col justify-between min-h-[120px]">
                      ...
                      <div>
                        <h3 className="text-2xl font-black text-white font-mono">{activeOrdersCount} <span className="text-xs text-zinc-500">{lang === "ar" ? "نشط" : "Active"}</span></h3>
                    ...
                    <div className="p-5 rounded-2xl bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 flex flex-col justify-between min-h-[120px]">
                      ...
                      <div>
                        <h3 className="text-2xl font-black text-emerald-400 font-mono">{menuData.length}</h3>
                        <p className="text-[10px] text-zinc-400 mt-1">{menuData.filter(m => m.inStock).length} {lang === "ar" ? "متوفر" : "in stock"}</p>
                      </div>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 pt-2">
                    ...
                    <div className="rounded-2xl bg-zinc-950 border border-zinc-900 p-5 flex flex-col justify-between">
                      ...
                      <div className="pt-4 border-t border-zinc-900 text-center">
                        <p className="text-[10px] text-zinc-500">{orders.length} {lang === "ar" ? "إجمالي الطلبات" : "total orders"}</p>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap gap-2 text-[10px]">
                            ...
                            <span className={`px-2 py-0.5 rounded font-black uppercase ${
                              o.paymentStatus === "paid" ? "bg-emerald-950 text-emerald-400" : o.paymentStatus === "refunded" ? "bg-zinc-800 text-zinc-400" : "bg-amber-950 text-amber-400"
                            }`}>{o.paymentMethod} · {o.paymentStatus}</span>
                        ...
                        <div className="flex flex-row sm:flex-col items-center sm:items-end gap-2">
                          ...
                          <div className="flex gap-1">
                            {o.paymentMethod === "cash" && o.paymentStatus === "pending" && (
                              <button type="button" onClick={() => updatePaymentStatus(o.id, "paid")}
                                className="h-7 px-2 rounded-lg bg-emerald-950 border border-emerald-800 text-emerald-400 text-[9px] font-black cursor-pointer">
                                {lang === "ar" ? "تم الاستلام" : "PAID"}
                              </button>
                            )}
                            {o.paymentStatus === "paid" && o.status === "Cancelled" && (
                              <button type="button" onClick={() => updatePaymentStatus(o.id, "refunded")}
                                className="h-7 px-2 rounded-lg bg-zinc-800 border border-zinc-700 text-zinc-400 text-[9px] font-black cursor-pointer">
                                {lang === "ar" ? "مسترد" : "REFUND"}
                              </button>
                            )}
                            <button type="button" onClick={() => printReceipt(o, lang)}
                              className="h-7 w-7 rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-500 hover:text-white flex items-center justify-center cursor-pointer">
                              <Printer size={11} />
                            </button>
                          </div>
                        </div>
              ...
              {ownerTab === "menu" && (
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <button type="button" onClick={() => setIsDeployModalOpen(true)}
                      className="h-9 px-4 rounded-lg bg-[#800020] text-xs font-black flex items-center gap-1.5 hover:bg-[#a0002c] transition-colors cursor-pointer">
                      <PlusCircle size={13} /> {lang === "ar" ? "إضافة منتج" : "Add Product"}
                    </button>
                  </div>
                    ...
                    {isDeployModalOpen && (
                      <motion.form initial={{ opacity: 0, y: -15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }}
                          ...
                          <div className="lg:col-span-2 space-y-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              <div>
                                ...
                                <input required value={newListing.nameEn}
                                  onChange={e => { setNewListing({ ...newListing, nameEn: e.target.value }); setListingErrors(p => ({ ...p, nameEn: "" })); }}
                                  placeholder="e.g. V60 Coffee"
                                  className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none ${listingErrors.nameEn ? "border-red-600" : "border-zinc-800"}`} />
                              ...
                              <div>
                                ...
                                <input required value={newListing.nameAr}
                                  onChange={e => { setNewListing({ ...newListing, nameAr: e.target.value }); setListingErrors(p => ({ ...p, nameAr: "" })); }}
                                  placeholder="مثال: قهوة V60"
                                  className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none text-right ${listingErrors.nameAr ? "border-red-600" : "border-zinc-800"}`} />
                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                ...
                                <input value={newListing.imgUrl} onChange={e => setNewListing({ ...newListing, imgUrl: e.target.value })}
                                  ...
                                  className="w-1/2 h-9 px-3 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none font-mono text-[11px]" />
                              </div>
                            </div>
                            <div className="grid grid-cols-3 gap-3">
                              <div>
                                ...
                                <input required type="number" step="0.01" min="0.01" value={newListing.price}
                                  ...
                                  placeholder="15"
                                  className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none ${listingErrors.price ? "border-red-600" : "border-zinc-800"}`} />
                              ...
                              <div>
                                ...
                                <input type="number" min="0" value={newListing.kcal}
                                  onChange={e => { setNewListing({ ...newListing, kcal: e.target.value }); setListingErrors(p => ({ ...p, kcal: "" })); }}
                                  placeholder="80"
                                  className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none ${listingErrors.kcal ? "border-red-600" : "border-zinc-800"}`} />
                              </div>
                              <div>
                                <label className="block text-[10px] text-zinc-400 mb-1 font-bold">{lang === "ar" ? "الفئة" : "Category"}</label>
                                <select value={newListing.cat} onChange={e => setNewListing({ ...newListing, cat: e.target.value })}
                                  className="w-full h-9 px-2 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              <div>
                                ...
                                <textarea value={newListing.descEn} onChange={e => setNewListing({ ...newListing, descEn: e.target.value })}
                                  placeholder="Product description..." rows={2}
                                  className="w-full px-3 py-2 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none resize-none" />
                              </div>
                              <div>
                                <label className="block text-[10px] text-zinc-400 mb-1 font-bold">{lang === "ar" ? "الوصف (عربي)" : "Arabic Description"}</label>
                                <textarea value={newListing.descAr} onChange={e => setNewListing({ ...newListing, descAr: e.target.value })}
                                  placeholder="وصف المنتج..." rows={2}
                                  className="w-full px-3 py-2 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none resize-none text-right" />
                              </div>
                            </div>
                          </div>
                          <div className="bg-black/50 border border-zinc-800 rounded-xl p-4 flex flex-col justify-between">
                            <div>
                              <div className="flex items-center gap-1.5 text-zinc-400 mb-2">
                                <Eye size={12} className="text-[#d9ab7d]" />
                              ...
                              <div className="relative h-36 rounded-lg bg-zinc-900 border border-zinc-800 overflow-hidden flex items-center justify-center">
                                {newListing.imgUrl?.trim() ? (
                                  <img key={newListing.imgUrl} src={newListing.imgUrl} className="w-full h-full object-cover" alt="Preview"
                                    onError={e => { e.currentTarget.src = "https://placehold.co/400x300?text=Invalid+URL"; }} />
                                ) : (
                                  <span className="text-[10px] text-zinc-600 p-4 text-center">No image yet</span>
                                )}
                              </div>
                            </div>
                        ...
                        <div className="flex gap-2 justify-end pt-2 border-t border-zinc-800">
                          <button type="button" onClick={() => { setIsDeployModalOpen(false); setListingErrors({}); }}
                            className="h-9 px-4 bg-zinc-800 hover:bg-zinc-700 text-white text-[11px] font-bold rounded-lg transition-colors cursor-pointer">
                            {lang === "ar" ? "إلغاء" : "Cancel"}
                          </button>
                        ...
                        {menuData.map(item => (
                          <tr key={item.id} className="border-t border-zinc-900 hover:bg-zinc-900/20">
                            ...
                            <td className="p-4 text-center">
                              <button type="button" onClick={() => deleteFromMenu(item.id)}
                                className="h-8 w-8 rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-500 hover:text-red-400 hover:border-red-900/40 transition-all flex items-center justify-center mx-auto cursor-pointer">
                                <Trash2 size={13} />
                              </button>
                            </td>
                          </tr>
                  ...
                  <div className="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-5 space-y-5">
                    <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
                      <h4 className="text-xs font-black uppercase text-[#d9ab7d] tracking-wider flex items-center gap-2">
                        <Megaphone size={12} /> {lang === "ar" ? "تحرير المحتوى" : "Edit Promotion"}
                      </h4>
                      <button type="button"
                        onClick={() => setPromoBlock(p => ({ ...p, active: !p.active }))}
                        className={`h-8 px-4 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer ${
                          promoBlock.active ? "bg-red-950/60 border border-red-800 text-red-400 hover:bg-red-900/60" : "bg-emerald-600 text-white hover:bg-emerald-500"
                        }`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input value={promoEdit.titleEn} onChange={e => setPromoEdit(p => ({ ...p, titleEn: e.target.value }))}
                          placeholder="This Week's Special"
                          className="w-full h-10 px-3 bg-black border border-zinc-800 rounded-xl text-xs text-white outline-none focus:border-[#800020] transition-colors" />
                      </div>
                      <div>
                        ...
                        <input value={promoEdit.titleAr} onChange={e => setPromoEdit(p => ({ ...p, titleAr: e.target.value }))}
                          placeholder="عرض هذا الأسبوع"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <textarea value={promoEdit.bodyEn} onChange={e => setPromoEdit(p => ({ ...p, bodyEn: e.target.value }))}
                          placeholder="Describe the promotion or offer..." rows={3}
                          className="w-full px-3 py-2 bg-black border border-zinc-800 rounded-xl text-xs text-white outline-none resize-none focus:border-[#800020] transition-colors" />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        ...
                        <input value={promoEdit.ctaEn} onChange={e => setPromoEdit(p => ({ ...p, ctaEn: e.target.value }))}
                      ...
                      <div>
                        ...
                        <input value={promoEdit.ctaAr} onChange={e => setPromoEdit(p => ({ ...p, ctaAr: e.target.value }))}
                      ...
                      <div>
                        ...
                        <input value={promoEdit.ctaUrl} onChange={e => setPromoEdit(p => ({ ...p, ctaUrl: e.target.value }))}
                          placeholder="https://..."
                    ...
                    {activeEvent && (
                      <motion.div
                        ...
                        <button type="button" onClick={() => setActiveEvent(null)}
                          className="h-8 px-3 rounded-lg bg-white/10 border border-white/20 text-white text-[10px] font-black uppercase tracking-wider cursor-pointer hover:bg-white/20 transition-all flex items-center gap-1.5">
                          <X size={11} /> {lang === "ar" ? "إيقاف" : "Deactivate"}
                        </button>
                      </motion.div>
                    )}
                  </AnimatePresence>
                ...
                <div className="max-w-md space-y-6">
                      ...
                      <button type="button"
                        onClick={() => {
                          if (isValidPin(pinChangeInput)) {
                            setOwnerPin(pinChangeInput);
                            showToast("PIN updated successfully!", "success", "pin-updated");
                            setPinChangeInput("");
                          } else { showToast("PIN must be exactly 4 digits.", "error", "pin-invalid"); }
                        }}
                        className="h-10 w-full rounded-lg bg-[#800020] text-white text-xs font-black uppercase tracking-widest cursor-pointer hover:bg-[#a0002c] transition-colors">
                        {lang === "ar" ? "حفظ الرمز الجديد" : "Save New PIN"}
                      </button>
                    </div>
                  </div>
                  <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
                  ...
                  <div className="rounded-2xl border border-red-900/40 bg-red-950/10 p-6">
                    ...
                    <button type="button" onClick={() => setShowClearConfirm(true)}
                      ...
                      <RotateCcw size={13} /> {lang === "ar" ? "مسح جميع الطلبات" : "Clear All Orders"}
                    </button>
                  </div>
        ...
        {isCartOpen && (
          <div className="fixed inset-0 z-[400] flex justify-end">
            ...
            <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }}
              ...
              className="relative w-full max-w-md h-full bg-zinc-950 flex flex-col p-5 shadow-2xl ltr:border-l rtl:border-r border-zinc-800 overflow-y-auto">
              <div className="flex justify-between items-center mb-5 flex-shrink-0">
                <div className="flex items-center gap-2">
                  <ShoppingBag size={17} className="text-[#d9ab7d]" />
                  <h3 className="font-black text-base text-white uppercase tracking-wider">{lang === "ar" ? "حقيبتك" : "Your Bag"}</h3>
                </div>
                <button type="button" onClick={() => setIsCartOpen(false)}
                  className="h-8 w-8 rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center cursor-pointer">
                  <X size={14} />
                </button>
              </div>
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-900 space-y-3 flex-shrink-0">
                    ...
                    <div>
                      <input type="text" required placeholder={lang === "ar" ? "الاسم الكريم *" : "Your Name *"}
                        value={customerInfo.name}
                        onChange={e => { setCustomerInfo({ ...customerInfo, name: e.target.value }); setCartErrors(p => ({ ...p, name: "" })); }}
                        className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none ${cartErrors.name ? "border-red-600" : "border-zinc-800 focus:border-[#800020]"}`} />
                      {cartErrors.name && <p className="text-red-400 text-[10px] mt-1">{cartErrors.name}</p>}
                    </div>
                    <div>
                      <input type="tel" required placeholder={lang === "ar" ? "رقم الجوال *" : "Phone Number *"}
                        value={customerInfo.phone}
                        onChange={e => { setCustomerInfo({ ...customerInfo, phone: e.target.value }); setCartErrors(p => ({ ...p, phone: "" })); }}
                        className={`w-full h-9 px-3 bg-black border rounded-lg text-xs text-white outline-none ${cartErrors.phone ? "border-red-600" : "border-zinc-800 focus:border-[#800020]"}`} />
                    ...
                    <select value={customerInfo.method}
                      ...
                      className="w-full h-9 px-2 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none focus:border-[#800020]">
                        ...
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }}
                          ...
                          <div className="p-3 rounded-xl bg-blue-950/20 border border-blue-800/30">
                            <div className="flex items-center gap-1.5 mb-2">
                              ...
                              <p className="text-[10px] font-black text-blue-400 uppercase tracking-wider">{lang === "ar" ? "تفاصيل عنوان التوصيل" : "Delivery Address"}</p>
                            </div>
                            <div className="space-y-2">
                              <div>
                                <input type="text" required placeholder={lang === "ar" ? "الشارع ورقم المبنى *" : "Street & building number *"}
                              ...
                              <input type="text" placeholder={lang === "ar" ? "معلم قريب (اختياري)" : "Nearby landmark (optional)"}
                    ...
                    <input type="text" maxLength={200} placeholder={lang === "ar" ? "ملاحظات خاصة (اختياري)" : "Special notes (optional)"}
                      value={customerInfo.notes}
                      onChange={e => setCustomerInfo({ ...customerInfo, notes: e.target.value })}
                      className="w-full h-9 px-3 bg-black border border-zinc-800 rounded-lg text-xs text-white outline-none focus:border-[#800020]" />
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <button type="button" onClick={() => setCustomerInfo({ ...customerInfo, paymentMethod: "cash" })}
                          className={`h-12 rounded-xl flex flex-col items-center justify-center gap-0.5 text-[10px] font-black uppercase border transition-all cursor-pointer active:scale-95 ${
                            customerInfo.paymentMethod === "cash" ? "bg-[#800020] border-[#800020] text-white shadow-lg" : "bg-zinc-900 border-zinc-800 text-zinc-400 hover:border-zinc-600"
                          }`}>
                          <Banknote size={15} />
                          <span>{lang === "ar" ? "كاش" : "Cash"}</span>
                        </button>
                        <button type="button" onClick={() => setCustomerInfo({ ...customerInfo, paymentMethod: "online" })}
                          className={`h-12 rounded-xl flex flex-col items-center justify-center gap-0.5 text-[10px] font-black uppercase border transition-all cursor-pointer active:scale-95 ${
                            customerInfo.paymentMethod === "online" ? "bg-[#800020] border-[#800020] text-white shadow-lg" : "bg-zinc-900 border-zinc-800 text-zinc-400 hover:border-zinc-600"
                          }`}>
                          <Smartphone size={15} />
                          <span>{lang === "ar" ? "موبايل" : "Mobile Pay"}</span>
                        </button>
                      </div>
            ...
            <motion.div
              ...
              <div className="flex items-center justify-between pb-4 border-b border-zinc-900 mb-4 flex-shrink-0">
                <div className="flex items-center gap-2.5">
                  ...
                  {activeCustomerOrders.length > 0 && (
                    <span className="text-[10px] bg-[#800020] text-white px-2 py-0.5 rounded-full font-black">
                      {activeCustomerOrders.length} {lang === "ar" ? "نشط" : "active"}
                    </span>
                  )}
                </div>
                <button type="button" onClick={() => setIsNotificationOpen(false)}
                  className="h-8 w-8 rounded-full bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center cursor-pointer transition-colors">
                  <X size={14} />
                </button>
              </div>
